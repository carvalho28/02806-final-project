      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-4xl lg:mx-0">
          ...
          <p className="mt-4 font-display text-2xl tracking-tight text-red-900">
            ...
            energy initiatives, it is evident how the country is charting a
            robust green path not just within its own borders but influencing
            the global dialogue on sustainability. From pioneering reductions in
            greenhouse gas emissions to leading the charge in renewable energy
            adoption,{' '}
            <b>
              Denmark&apos;s journey represents a compelling blueprint for
          ...
          <p className="mt-4 font-display text-2xl tracking-tight text-red-900">
            ...
            emissions, we can&apos;t deny Denmark&apos;s proactive approach and
            its commitment to environmental innovations and policies.
          </p>
          <p className="mt-4 font-display text-2xl tracking-tight text-red-900">
